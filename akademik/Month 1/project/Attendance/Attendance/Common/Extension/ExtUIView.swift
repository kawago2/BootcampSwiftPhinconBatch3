...
extension UIView {
    func setShadow(cornerRadius: CGFloat = 20, shadowColor: CGColor = UIColor.black.cgColor, shadowOpacity: Float = 0.3, shadowOffset: CGSize = CGSize(width: 0, height: 2), shadowRadius: CGFloat = 2, clipsToBounds: Bool = false) {
